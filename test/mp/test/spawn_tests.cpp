...
#include <sys/wait.h>
||||||| parent of 52e20dd (util: Add Windows support)
#include <sys/wait.h>
=======
>>>>>>> 52e20dd (util: Add Windows support)
#include <thread>
#include <tuple>
#include <utility>
#include <vector>
...
<<<<<<< HEAD
>>>>>>> 52e20dd (util: Add Windows support)
||||||| parent of ef7a7a2 (SpawnProcess on Windows creates a named pipe with PIPE_WAIT and then calls)
=======
} // namespace
>>>>>>> ef7a7a2 (SpawnProcess on Windows creates a named pipe with PIPE_WAIT and then calls)
} // namespace test
} // namespace mp

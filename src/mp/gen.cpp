    ...
    const std::vector<kj::Own<const kj::ReadableDirectory>>& import_dirs)
{
    ...
    cpp_server << "#include <" << include_path << ".proxy-types.h> // IWYU pragma: keep\n";
    ...
    cpp_client << "#include <" << include_path << ".h> // IWYU pragma: keep\n";
    cpp_client << "#include <" << include_path << ".proxy.h>\n";
    cpp_client << "#include <" << include_path << ".proxy-types.h> // IWYU pragma: keep\n";
    ...
    cpp_client << "#include <" << PROXY_TYPES << "> // IWYU pragma: keep\n\n";

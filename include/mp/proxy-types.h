...
//!     clientInvoke(*this, &ClassName::Client::methodNameRequest, MakeClientParam<...>(arg0), MakeClientParam<...>>(arg1), MakeClientParam<...>(result));
//!     return result;
//! }
//!
...
//!
//! kj::Promise<void> ProxyServer<ClassName>::methodName(CallContext call_context) {

...
||||||| parent of 557fd29 (proxy-types: document PassField proxy.capnp Context overload)
=======
                    // Before invoking the function, store a reference to the
                    // callbackThread provided by the client in the
                    // thread_local.request_threads map. This way, if this
                    ...
                    // existing map value.
>>>>>>> 557fd29 (proxy-types: document PassField proxy.capnp Context overload)
...
||||||| parent of 66a2b4d (proxy-types Drop JoinPromises function)
=======
    // Lookup Thread object specified by the client. The specified thread should
    // be a local Thread::Server object, but it needs to be looked up
    // asynchronousely with getLocalServer().
>>>>>>> 66a2b4d (proxy-types Drop JoinPromises function)
...
||||||| parent of 3623c6d (proxy-types: document serverInvoke ReplaceVoid usage)
=======
...
>>>>>>> 3623c6d (proxy-types: document serverInvoke ReplaceVoid usage)
